...
process.hltOutputA = cms.OutputModule( "PoolOutputModule",
    ...
    SelectEvents = cms.untracked.PSet(  SelectEvents = ( cms.vstring( 'HLT_AK4CaloJetsForMC_v2',
  'HLT_AK4PFJetsForMC_v2',
  'HLT_AK8CaloHTForMC_v2',
  'HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV0p41_v2',
  'HLT_AK8PFHT700_TrimR0p1PT0p03Mass50_v2',
  'HLT_AK8PFHTForMC_v2',
  'HLT_AK8PFJet360_TrimMass30_v2',
  'HLT_AK8PFJetsForMC_v2',
  ...
  'HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v2',
  'HLT_Mu8_TrkIsoVVL_v2',
  'HLT_Mu8_v2')+cms.vstring( 'HLT_PFHT200_DiPFJetAve90_PFAlphaT0p63_v1',
  'HLT_PFHT200_v1',
  'HLT_PFHT250_DiPFJetAve90_PFAlphaT0p58_v1',
  'HLT_PFHT250_v1',
  'HLT_PFHT300_DiPFJetAve90_PFAlphaT0p54_v1',
...
process.ExpressOutput = cms.EndPath( process.hltPreExpressOutput + process.hltOutputExpress )


process.HLTSchedule = cms.Schedule( *(process.AOutput, process.DQMOutput, process.RPCMONOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ExpressOutput ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/mc/Phys14DR/QCD_Pt-15to30_Tune4C_13TeV_pythia8/GEN-SIM-RAW/AVE30BX50_tsg_castor_PHYS14_ST_V1-v2/00000/00772713-9E92-E411-9649-001E6739672F.root',
    ),
...
if 'GlobalTag' in process.__dict__:
    ...
    process.GlobalTag = customiseGlobalTag(process.GlobalTag, globaltag = 'PHY1474_STV4')
